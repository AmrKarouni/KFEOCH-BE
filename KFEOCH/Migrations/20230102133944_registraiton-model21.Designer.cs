...
namespace KFEOCH.Migrations
{
    ...
    [Migration("20230102133944_registraiton-model21")]
    partial class registraitonmodel21
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KFEOCH.Models.License", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KFEOCH.Models.OfficePayment", b =>
                {
                    ...
                    b.Property<string>("RequestNameArabic")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RequestNameEnglish")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("TypeId")
                        .HasColumnType("int");

                    b.Property<double>("YearsCount")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("LicenseSpeciality", b =>
                {
                    ...
                    b.HasKey("LicensesId", "SpecialitiesId");

                    b.HasIndex("SpecialitiesId");

                    b.ToTable("LicenseSpeciality");
                });
            ...
            modelBuilder.Entity("KFEOCH.Models.License", b =>
                {
                    b.HasOne("KFEOCH.Models.Dictionaries.OfficeEntity", "OfficeEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("LicenseSpeciality", b =>
                {
                    b.HasOne("KFEOCH.Models.License", null)
                        .WithMany()
                        .HasForeignKey("LicensesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KFEOCH.Models.Dictionaries.Speciality", null)
                        .WithMany()
